            ...
            <div className="mx-auto w-full max-w-4xl">
                ...
                <div className="space-y-10">
                    <div className="rounded-2xl border border-white/10 bg-slate-800/50 p-6 shadow-2xl backdrop-blur-lg">
                        ...
                        <form action={addFoodItem} className="mt-4 space-y-4">
                            <input
                                name="name"
                                type="text"
                                required
                            ...
                            <div className="flex items-center gap-x-6 gap-y-4 pt-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <label
                                        htmlFor="isWeekendOnly"
                                        className="text-sm font-medium text-slate-300"
                                    >
                                        Weekends only
                                    </label>
                                </div>
                                {/* You can add other checkboxes like isFeatured here if needed */}
                            </div>
