...
export function FoodDetailClient({ food }: Props) {
    ...
    return (
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 pb-20 pt-6">
            ...
            <main className="grid gap-8 rounded-2xl border border-white/10 bg-slate-800/50 p-6 shadow-2xl backdrop-blur-lg md:grid-cols-2 md:gap-12 md:p-8">
                ...
                <Link
                    href="/"
                    className="cursor-pointer rounded-full border border-white/10 bg-slate-800/50 px-4 py-2 text-sm font-medium text-slate-200 shadow-lg shadow-black/20 backdrop-blur-lg transition-all hover:bg-slate-700/50 hover:shadow-xl active:bg-slate-800 md:col-span-2 md:w-max"
                >
                    &larr; Back
                </Link>
            </main>
